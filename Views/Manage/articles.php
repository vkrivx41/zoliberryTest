            ...
            <div class="manage-articles-contents">
                ...
                <div class="top-nav">
                    <div class="create-new">
                        <a href="/Dashboard/ceate">Create new article</a>
                    </div>
                    <div class="search-element">
                        <form style="display: flex" action="/Dashboard/Manage/Articles">
                    ...
                    <div class="manage-list">
                        ...
                        foreach ($this->data ?? [] as $key => $value): ?>
                            <div class="article">
                                ...
                                <div class="actions">
                                    <div class="delete">
                                        <a href="#" data-id="<?= $value['id'] ?>">D</a>
                                    </div>
                                    <div class="edit">
                                        <a href="/Dashboard/Manage/Articles/Edit?id=<?=$value['id'] ?>">E</a>
                                    </div>
                                </div>
                            </div>
                        <?php endforeach; ?>
                ...
                <div class="loadmore">
                    <a href="<?= "/Dashboard/Manage/Articles?limit=".$limit ?>">Load more</a>
                </div>
            </div>
        </div>
    </div>
