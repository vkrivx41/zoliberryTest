...
<head>
    ...
    <script type="module" src="/js/ModeratorsController.js"></script>
</head>
<body>
    <div class="nav-bar">
            ...
            <div class="manage-authors-contents">
                <div class="top-nav">
                    <div class="create-new">
                        <a href="/Dashboard/Create/Moderator">Create new moderator</a>
                    </div>
                    <div class="count"><?= count($this->data ?? []) ?? 0?></div>
                    <div class="count-text">Active moderators</div>
                </div>
